...
SC_NOTES = {  # from the scouting reports written 3 Sep (vitesse-analysis/scouting/*.md)
 ...
 "dahbo": {
   ...
   "fit": "Vitesse have used him where the vendor does not rate him: two substitute appearances, then a first start at Den Bosch as one of a midfield three in a 4-3-3, in a side now averaging more passes per possession and keeping 57% of the ball. A possession side needs players who keep it under pressure, and that is his strongest row: 87% pressure resistance (3rd of 72) and first of 72 on low turnovers per reception. It also needs ball-winning when the ball is lost, which last season was Vitesse’s worst phase (retention after a recovery 19th of 20) and is his other strength (1st on defensive actions won). What the current shape asks for that he has not shown is creation from the centre: Tahaui’s 10 assists left with him, and Dahbo has two in 1,528 Allsvenskan minutes. Vitesse are 7th on seven points from four matches; his 123 minutes are too few to have moved that either way."},
 "decarvalho": {
   ...
   "fit": "He fits the side Vitesse are playing as, not the one they were. Over the first three matches the crosses went up from 16.7 to 26 a match and box entries from 23 to 39, and a winger whose best row is receptions inside the penalty area (2nd of 21) is the player that pattern feeds; his goal at Den Bosch and both assists came in those four matches. The side is pressing slightly less than last season (PPDA 12.1 to 13.1), which makes his counter-pressing (1st of 21) a resource the team is not yet built around rather than a requirement. The one line to watch as the ball is kept more (57% possession) is his involvement in the build-up, where he is 19th of 21 on touches and 18th on passes into the final third; Vitesse have played him on the right for 60% of his minutes and the left for 30%, and the vendor’s zone reads are consistent that he produces from the right."},
}
scouting = []
for key in ["wouters", "dahbo", "decarvalho"]:
    ...
    scouting.append({"key": key, "name": n["name"], "role": n["role"], "sample": n["sample"], "pool": pool, "poolLabel": n["poolLabel"],
                     "facets": facets, "shows": n["shows"], "cannot": n["cannot"], "prose": n["prose"], "fit": n["fit"], "period": n["period"], "periodLabel": n["periodLabel"]})
...
D = {
    ...
    "signings": [
        {"name": "Pontus Dahbo", "age": 20, "pos": "Attacking midfield", "from": "BK Häcken", "when": "13 Aug 2026", "value": "€2.00m", "contract": "June 2027",
         "sample": "BK Häcken, Allsvenskan · 2025: 1,308 min, 23 apps, 1G 2A · 2026: 220 min, 9 apps, 1 start, 0G 0A", "league": "Two seasons before the move, both from vendor reports", "sofar": "123 min; first start at Den Bosch. Listed by Transfermarkt as a loan",
         "read": "Everything rated about him is from before the move, two Swedish seasons at Häcken: 1,308 Allsvenskan minutes in 2025, and 220 in 2026 before the move, only a few games, and read that way. What both seasons agree on is the ball-winning: first of 72 Allsvenskan wingers on defensive actions won and on defensive intensity this year (Twelve), top three among attacking midfielders on possession gains last year (MyGamePlan), and an 87% success rate under pressure. That is the profile Vitesse's transition game has lacked: retention after a recovery was 19th of 20. What 220 minutes cannot show is chance creation and goals; those are counts of zero and one, not verdicts. Vitesse have already used him centrally. Transfermarkt lists the move as a loan from Häcken; the question is the option.",
        ...
        {"name": "Eduard Probst", "age": 25, "pos": "Centre-forward", "from": "SV Rödinghausen", "when": "7 Jul 2026", "value": "€200k", "contract": "June 2028",
         ...
         "read": "Before Vitesse: three goals in 366 bench minutes in the 3. Bundesliga, a rate rather than a record. Brought in against Huth's departure; the honest position is that a season of Eerste Divisie minutes will settle it and nothing before that will.",
